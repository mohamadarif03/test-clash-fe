export const LoginIllustration = () => {
  return (
    <div className="hidden lg:flex w-1/2 relative flex-col items-center justify-center bg-gradient-to-br from-royal-blue-start to-royal-blue-end overflow-hidden p-8">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-lg">
        ...
        <div className="mb-10 relative">
          ...
          <img 
            ...
            className="relative w-full max-w-sm h-auto object-contain drop-shadow-2xl rounded-2xl border-4 border-white/10" 
        ...
        <h2 className="text-white text-3xl font-black tracking-tight mb-3 drop-shadow-lg">
          Tingkatkan Cara Belajarmu
        </h2>
        <p className="text-blue-100 text-base font-light leading-relaxed max-w-sm">
