        ...
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-100 px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="relative hidden md:block w-96">
                    ...
                    <input className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-none rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-primary/20 placeholder-gray-400 focus:outline-none" placeholder="Search for users, questions..." type="text"/>
                </div>
                {/* Actions */}
